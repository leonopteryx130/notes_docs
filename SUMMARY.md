...
* AI
    ...
    * 深度学习模型架构
        ...
        * [Multi-Head Attention](./notes/AI/深度学习模型架构/Multi-Head Attention.md)
    * pytorch
...
* 计算机科学
    ...
    * 数据结构及其算法
        ...
        * [正排索引和倒排索引](./notes/计算机科学/数据结构及其算法/正排索引和倒排索引.md)
    ...
    * 计算机图形学
        ...
        * [图像噪声](./notes/计算机科学/计算机图形学/图像噪声.md)
        ...
        * [直线的光栅化算法](./notes/计算机科学/计算机图形学/直线的光栅化算法.md)
        * [FXAA](./notes/计算机科学/计算机图形学/FXAA.md)
    * 编程语言
...
* 数学
    * 理论数学
        ...
        * [向量的内积和外积](./notes/数学/理论数学/向量的内积和外积.md)
        * [质心](./notes/数学/理论数学/质心.md)
        * [转移概率矩阵](./notes/数学/理论数学/转移概率矩阵.md)
        * [复合函数求导](./notes/数学/理论数学/复合函数求导.md)
        * [偏导数和梯度](./notes/数学/理论数学/偏导数和梯度.md)
        * [概率，几率，对数几率](./notes/数学/理论数学/概率，几率，对数几率.md)
        * [全概率公式和贝叶斯公式](./notes/数学/理论数学/全概率公式和贝叶斯公式.md)
        ...
        * [Intersection over Union交并比](./notes/数学/理论数学/IoU交并比.md)
    * 应用数学
        ...
        * [向量和矩阵的相似度计算](./notes/数学/应用数学/向量和矩阵的相似度计算.md)
        * [n-gram](./notes/数学/应用数学/n-gram.md)